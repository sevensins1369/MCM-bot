...
function getPreferencesFromFile(userId) {
    try {
        ...
        console.error(`Error reading preferences from file for user ${userId}:`, error);
        return createDefaultPreferences(userId);
    }
}
    ...
    try {
        ...
        if (isUsingMongoDB()) {
            try {
                ...
                console.error(`Error updating preferences in MongoDB for user ${userId}:`, error);
            }
        } else {
            savePreferences();
        }
...
function loadPreferences() {
    try {
        if (fs.existsSync(PREFERENCES_FILE)) {
            ...
            console.log('No user preferences file found. Starting with empty preferences cache.');
